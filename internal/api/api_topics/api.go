...
func (api *TopicGroupApi) prepareRequest(node config.GroupNode, page int) error {
...
func (api *TopicGroupApi) groupRequestData(groupNode config.GroupNode) (
